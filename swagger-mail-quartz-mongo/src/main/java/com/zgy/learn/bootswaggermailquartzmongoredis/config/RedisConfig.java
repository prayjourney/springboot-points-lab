 ...
 * 这个名字需要和原有的名字有区别，然后在使用的地方，进行注入的时候，需要使用我们自己写的template来注入，即可。
 * @date: Created in 2020/4/19 12:30
 * @modified by: https://segmentfault.com/a/1190000020314044, https://blog.csdn
 * .net/weixin_38312502/article/details/80916222
 */
@Configuration
